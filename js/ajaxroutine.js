//   Project Name:  Contact Form Builder
//   Author:   Tom Gabrysiak
//   Date Started: April 26th, 2012
...
ajaxpack.divid="content"
ajaxpack.loading="<br><br><center><img src='images/ajax-loader.gif' border='0' /></center>"
ajaxpack.addrandomnumber=0 //Set to 1 or 0. See documentation.

ajaxpack.getAjaxRequest=function(url, parameters, callbackfunc, filetype, divid, loading){
...
this.ajaxobj.open('GET', url+"?"+parameters+"&rand="+Math.random(), true)
this.ajaxobj.send(null)
}
}

ajaxpack.postAjaxRequest=function(url, parameters, callbackfunc, filetype, divid, loading){
ajaxpack.ajaxobj=createAjaxObj() //recreate ajax object to defeat cache problem in IE
if (this.ajaxobj){
this.filetype=filetype
this.divid=divid
...
function processGetPost(){
	var divid=ajaxpack.divid
	var loading=ajaxpack.loading
	...
	if (myajax.readyState == 4){ //if request of file completed
		if (myajax.status==200 || window.location.href.indexOf("http")==-1){ 
			...
			document.getElementById(divid).innerHTML=myajax.responseXML
		}
	}
}
